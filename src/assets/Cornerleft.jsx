...
export default function Cornerleft() {
    return (
        ...
        <path d="M194 196C194 88.3045 107.143 1 0 1" stroke="#BA0848"/>
        <path d="M0 9C103.277 9 187 92.7228 187 196H0V9Z" fill="#C80048"/>
        <g filter="url(#filter0_i_542_366)">
        <path d="M0 20C97.2021 20 176 98.7979 176 196H0V20Z" fill="url(#paint0_linear_542_366)"/>
        </g>
        <defs>
